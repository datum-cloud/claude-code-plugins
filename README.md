...
|--------|-------------|---------|
| [datum-platform](./plugins/datum-platform/) | Kubernetes platform engineering automation with aggregated API servers, controller patterns, and GitOps deployment | 1.18.0 |
...
- A writing gate that blocks a GitHub post when it misses the bar: the full bar for PR and issue bodies, and the rules that hold everywhere for comments, reviews, and release notes
